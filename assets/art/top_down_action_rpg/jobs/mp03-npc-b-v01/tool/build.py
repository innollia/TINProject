    ...
    for path in paths:
        ...
        for frame in frames:
            ...
            manifest = {
                ...
                "alpha": recipe.get("style", "sprite") != "environment",
                "pivot": result["pivot"],
            ...
            # mp03: copy the recipe's identity (npc id, body/portrait key, art key) and
            # anchors (e.g. the portrait face anchor, output px) into the manifest.
            for extra in ("identity", "anchors"):
                if extra in recipe:
                    manifest[extra] = recipe[extra]
