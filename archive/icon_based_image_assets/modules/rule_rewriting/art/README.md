...
Archived from `modules/rule_rewriting/art/` on 2026-09-25. The SVG/PNG outputs remain in that original project directory unchanged; this document and the generation scripts are preserved here as the former at-icons recipe.
